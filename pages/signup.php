    ...
    <body>
        ...
        <div class="paragraph" style="border:0;">
            <form action="../backend/signup.php" method="POST" name="signup-form">
                ...
                <br>
                <br>
                <input type="button" value="Sign Up" class="btn btn-outline-dark" onclick="SignUp()">
                <input type="button" value="Cancel" class="btn btn-outline-dark" onclick="ClearForm()">
            </form>
        </div>
        ...
        <br>
        <input type="button" value="Login" style="margin-left: 10;" class="btn btn-outline-dark" onclick="Login()">
        <script>
            function Login() {
